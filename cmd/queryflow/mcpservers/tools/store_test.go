	...
	tests := []struct {
		...
		// Working case
		{
			...
			"pageNumber": 0
				...
				"POST:/v2/entrypoint/mcp-server/4957145b-6192-4862-a5da-e97853974e9f/tool": {
					StatusCode: http.StatusOK,
					Body: `{
					"type": "mongo",
					"name": "MongoDB mcp-server tool",
					...
					Assertions: func(t *testing.T, r *http.Request) {
						assert.Equal(t, http.MethodPost, r.Method)
						assert.Equal(t, "/v2/entrypoint/mcp-server/4957145b-6192-4862-a5da-e97853974e9f/tool", r.URL.Path)
					},
				},
			},
			err: nil,
		},
		{
			...
			{
			"type": "mongo",
			"name": "MongoDB mcp-server tool 2",
			"labels": [],
			"active": true,
			...
			"pageNumber": 0
				...
				"PUT:/v2/entrypoint/mcp-server/4957145b-6192-4862-a5da-e97853974e9f/tool/9ababe08-0b74-4672-bb7c-e7a8227d6d4d": {
					...
					Assertions: func(t *testing.T, r *http.Request) {
						...
						assert.Equal(t, "/v2/entrypoint/mcp-server/4957145b-6192-4862-a5da-e97853974e9f/tool/9ababe08-0b74-4672-bb7c-e7a8227d6d4d", r.URL.Path)
						assert.Equal(t, "apiKey123", r.Header.Get("X-API-Key"))
					},
				},
				"PUT:/v2/entrypoint/mcp-server/4957145b-6192-4862-a5da-e97853974e9f/tool/9ababe08-0b74-4672-bb7c-e7a8227d6dad": {
					StatusCode: http.StatusOK,
					Body: `{
					"type": "openai",
					"name": "OpenAI mcp-server tool",
					"labels": [],
					"active": true,
					"id": "9ababe08-0b74-4672-bb7c-e7a8227d6dad",
					"creationTimestamp": "2025-08-14T18:02:11Z",
					...
					Assertions: func(t *testing.T, r *http.Request) {
						assert.Equal(t, http.MethodPut, r.Method)
						assert.Equal(t, "/v2/entrypoint/mcp-server/4957145b-6192-4862-a5da-e97853974e9f/tool/9ababe08-0b74-4672-bb7c-e7a8227d6dad", r.URL.Path)
						assert.Equal(t, "apiKey123", r.Header.Get("X-API-Key"))
					},
				},
			...
			"pageNumber": 0
				...
				"GET:/v2/entrypoint/mcp-server/4957145b-6192-4862-a5da-e97853974e9f/tool/9ababe08-0b74-4672-bb7c-e7a8227d6dad": {
					StatusCode: http.StatusOK,
					Body: `{
				"type": "openai",
				"name": "OpenAI mcp-server tool 3",
		...
		{
			name:         "StoreCommand receives an MCP server that does not exist.",
			url:          true,
			apiKey:       "apiKey123",
			outGolden:    "NewStoreCommand_Out_MCPServerDoesNotExist",
			errGolden:    "NewStoreCommand_Err_MCPServerDoesNotExist",
			outBytes:     []byte(nil),
			errBytes:     testutils.Read(t, "NewStoreCommand_Err_MCPServerDoesNotExist"),
			mcpServer:    "my-mcp-server",
			data:         "",
			file:         "testdata/StoreCommand_JSONFile.json",
			abortOnError: false,
...
func TestNewStoreCommand_MultipleFiles(t *testing.T) {
	...
	"pageNumber": 0
		...
		"PUT:/v2/entrypoint/mcp-server/4957145b-6192-4862-a5da-e97853974e9f/tool/2fba75cd-e5dc-454f-b028-a505f0c690b2": {
			StatusCode: http.StatusOK,
			Body: `{
				"type": "mongo",
				"name": "MongoDB mcp-server tool 4",
				"labels": [],
				"active": true,
			...
			Assertions: func(t *testing.T, r *http.Request) {
				assert.Equal(t, http.MethodPut, r.Method)
				assert.Equal(t, "/v2/entrypoint/mcp-server/4957145b-6192-4862-a5da-e97853974e9f/tool/2fba75cd-e5dc-454f-b028-a505f0c690b2", r.URL.Path)
				assert.Equal(t, "apiKey123", r.Header.Get("X-API-Key"))
			},
		},
		"PUT:/v2/entrypoint/mcp-server/4957145b-6192-4862-a5da-e97853974e9f/tool/77cd87e5-5c29-4960-9058-4a2eda0c513f": {
			StatusCode: http.StatusOK,
			Body: `{
				"type": "openai",
				"name": "OpenAI mcp-server tool 5",
				"labels": [],
				"active": true,
			...
			Assertions: func(t *testing.T, r *http.Request) {
				assert.Equal(t, http.MethodPut, r.Method)
				assert.Equal(t, "/v2/entrypoint/mcp-server/4957145b-6192-4862-a5da-e97853974e9f/tool/77cd87e5-5c29-4960-9058-4a2eda0c513f", r.URL.Path)
				assert.Equal(t, "apiKey123", r.Header.Get("X-API-Key"))
			},
		},
	}
	...
	vpr.Set("output", "json")
	vpr.Set("default.queryflow_url", srv.URL)
	vpr.Set("default.queryflow_key", "apiKey123")
	...
	args := []string{"my-mcp-server", "testdata/StoreCommand_JSONFile.json", "testdata/StoreCommand_JSONFile2.json"}
...
func TestNewStoreCommand_NoMCPServer(t *testing.T) {
	...
	testutils.CompareBytes(t, "NewStoreCommand_Err_NoMCPServer", testutils.Read(t, "NewStoreCommand_Err_NoMCPServer"), errBuf.Bytes())
}
