...
func NewDeleteCommand(d cli.Discovery) *cobra.Command {
	get := &cobra.Command{
		...
		Long:  fmt.Sprintf(cli.LongDeleteNoNames, "secret", "Core"),
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return cli.DeleteCommand(args[0], d, coreClient.Secrets(), cli.GetCommandConfig(profile, vpr.GetString("output"), "Core", "core_url", "core_key"))
		},
