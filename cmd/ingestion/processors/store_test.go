	...
	tests := []struct {
		...
		},
		{
			...
			responses: map[string]testutils.MockResponse{
				...
				"/v2/processor/9ababe08-0b74-4672-bb7c-e7a8227d6d4d": {
				...
				"/v2/processor/9ababe08-0b74-4672-bb7c-e7a8227d6dad": {
					StatusCode: http.StatusOK,
					Body: `{
					"type": "openai",
