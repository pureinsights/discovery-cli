...
func TestNewGetCommand(t *testing.T) {
	tests := []struct {
		...
		// Working case
		{
			...
			args:       []string{"processor test clone 10"},
			url:        true,
			apiKey:     "apiKey123",
			...
			"content": [
				...
				"singestion": 1.4854797
				},
				{
				"source": {
					"type": "mongo",
					"name": "processor test 1 clone",
					"labels": [
					{
						"key": "A",
						"value": "A"
		...
		},
		{
			...
			"content": [
				{
				"type": "mongo",
				"name": "processor test 1 clone 10",
				"labels": [
					{
					"key": "A",
					"value": "A"
				...
				{
				"type": "openai",
				"name": "OpenAI processor clone clone",
				"labels": [],
				"active": true,
	...
	"timestamp": "2025-09-30T15:38:42.885125200Z"
		...
		},
		{
			...
			statusCode: http.StatusOK,
			response: `{
			"content": [{"source":{"active":true,"creationTimestamp":"2025-08-14T18:02:38Z","id":"5f125024-1e5e-4591-9fee-365dc20eeeed","processors":[],"lastUpdatedTimestamp":"2025-08-18T20:55:43Z","name":"test","type":mongo"}},       
