		...
		// Working case
		{
			...
			"pageNumber": 0
				...
				"GET:/v2/seed/schedule/3d51beef-8b90-40aa-84b5-033241dc6239": {
					...
					"creationTimestamp": "2026-03-27T15:59:25.613548Z",
					"lastUpdatedTimestamp": "2026-03-27T15:59:25.613548Z",
					"expression": "0 * * * *",
				...
				"DELETE:/v2/seed/schedule/3d51beef-8b90-40aa-84b5-033241dc6239": {
					StatusCode: http.StatusOK,
					Body: `{
				"acknowledged": true
			}`,
		...
		},
		{
			...
			"content": [
				...
				"source": {
					...
					"active": true,
					"id": "3d51beef-8b90-40aa-84b5-033241dc6239",
					"creationTimestamp": "2026-03-27T15:59:26Z",
					"lastUpdatedTimestamp": "2026-03-27T15:59:26Z"
				},
				"highlight": {}
			],
			"pageable": {
...
func TestNewDeleteCommand_NoProfileFlag(t *testing.T) {
	...
	deleteCmd.SetArgs([]string{"my-seed-schedule"})
