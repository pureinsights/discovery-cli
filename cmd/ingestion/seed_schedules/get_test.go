	...
	tests := []struct {
		...
		// Working case
		{
			...
			"pageNumber": 0
					...
					Assertions: func(t *testing.T, r *http.Request) {
						...
						assert.Equal(t, "/v2/seed/schedule/search", r.URL.Path)
					},
				},
				"GET:/v2/seed/schedule/3b32e410-2f33-412d-9fb8-17970131921c": {
					StatusCode: http.StatusOK,
					Body: `{
						"name": "my-seed-schedule",
						"labels": [
						...
						"expression": "0 0 * * *",
						"seed": "3b32e410-2f33-412d-9fb8-17970131921c",
						"scanType": "FULL"
				}`,
					ContentType: "application/json",
					Assertions: func(t *testing.T, r *http.Request) {
						assert.Equal(t, http.MethodGet, r.Method)
						assert.Equal(t, "/v2/seed/schedule/3b32e410-2f33-412d-9fb8-17970131921c", r.URL.Path)
					},
				},
			},
			err: nil,
		},
		{
			...
			"pageNumber": 0
					...
					Assertions: func(t *testing.T, r *http.Request) {
						assert.Equal(t, http.MethodGet, r.Method)
						assert.Equal(t, "/v2/seed/schedule", r.URL.Path)
	...
	"timestamp": "2025-09-30T15:38:42.885125200Z"
		...
		},
		{
			...
			"pageNumber": 0
				...
				"GET:/v2/seed/schedule/3d51beef-8b90-40aa-84b5-033241dc6239": {
					StatusCode:  http.StatusOK,
					ContentType: "application/json",
					Body: `{
					"name": "my-seed-schedule",
					...
					"lastUpdatedTimestamp": "2025-10-17T22:37:53Z",
					"expression": "0 0 * * *",
					"seed": "3d51beef-8b90-40aa-84b5-033241dc6239",
					"scanType": "FULL"
				}`,
					Assertions: func(t *testing.T, r *http.Request) {
						assert.Equal(t, http.MethodGet, r.Method)
						assert.Equal(t, "/v2/seed/schedule/3d51beef-8b90-40aa-84b5-033241dc6239", r.URL.Path)
						assert.Equal(t, "apiKey123", r.Header.Get("X-API-Key"))
					},
				},
			},
		...
		},
		{
			...
			responses: map[string]testutils.MockResponse{
				"GET:/v2/seed/schedule": {
					StatusCode: http.StatusOK,
					Body: `{
			"content": [{"source":{"active":true,"creationTimestamp":"2025-08-21T17:57:16Z","id":"3393f6d9-94c1-4b70-ba02-5f582727d998","lastUpdatedTimestamp":"2025-08-21T17:57:16Z","name":"test"}},     
			{"source":{"active":true,"creationTimestamp":"2025-08-14T18:02:38Z","id":"5f125024-1e5e-4591-9fee-365dc20eeeed","lastUpdatedTimestamp":"2025-08-18T20:55:43Z","name":another-schedule}},       
			{"source":{"active":true,"creationTimestamp":"2025-08-14T18:02:38Z","id":"86e7f920-a4e4-4b64-be84-5437a7673db8","lastUpdatedTimestamp":"2025-08-14T18:02:38Z","name":"third-schedule"}},       
			],
			"pageable": {
				"page": 0,
				"size": 3,
			...
			err: cli.NewErrorWithCause(cli.ErrorExitCode, errors.New("invalid character 'a' looking for beginning of value"), "Could not print JSON Array"),
		},
	}
