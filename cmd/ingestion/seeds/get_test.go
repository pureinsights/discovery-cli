...
func TestNewGetCommand(t *testing.T) {
	tests := []struct {
		...
		// Working case
		{
			...
			args:       []string{"seed test clone 10"},
			url:        true,
			apiKey:     "apiKey123",
	...
	"timestamp": "2025-09-30T15:38:42.885125200Z"
		...
		},
		{
			...
			statusCode: http.StatusOK,
			response: `{
			"content": [{"source":{"active":true,"creationTimestamp":"2025-08-14T18:02:38Z","id":"5f125024-1e5e-4591-9fee-365dc20eeeed","seeds":[],"lastUpdatedTimestamp":"2025-08-18T20:55:43Z","name":"test","type":mongo"}},       
