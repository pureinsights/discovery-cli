...
const (
	...
	LongExport string = "export is the command used to backup Discovery %[2]s's entities. The user can send the specific file in which to save the configurations. If not, they will be saved in a zip file in the current directory."
)
