...
func TestWriteExport(t *testing.T) {
	...
	tests := []struct {
		...
		// Working case
		{
			...
			client:              new(mocks.WorkingIngestionBackupRestore),
...
func TestWriteExportsIntoFile(t *testing.T) {
	tests := []struct {
		...
		// Working case
		{
			...
			clients:        []BackupRestoreClientEntry{{Name: "core", Client: new(mocks.WorkingCoreBackupRestore)}, {Name: "ingestion", Client: new(mocks.WorkingIngestionBackupRestore)}, {Name: "queryflow", Client: new(mocks.WorkingQueryFlowBackupRestore)}},
			path:           filepath.Join(t.TempDir(), "export.zip"),
		...
		},
		{
			...
			clients:        []BackupRestoreClientEntry{{Name: "core", Client: new(mocks.WorkingCoreBackupRestore)}, {Name: "ingestion", Client: new(mocks.FailingBackupRestore)}, {Name: "queryflow", Client: new(mocks.WorkingQueryFlowBackupRestore)}},
			path:           filepath.Join(t.TempDir(), "export.zip"),
		...
		},
		{
			...
			clients:        []BackupRestoreClientEntry{{Name: "", Client: new(mocks.WorkingCoreBackupRestore)}, {Name: "ingestion", Client: new(mocks.WorkingIngestionBackupRestore)}, {Name: "queryflow", Client: new(mocks.WorkingQueryFlowBackupRestore)}},
			path:           filepath.Join(t.TempDir(), "export.zip"),
			expectedOutput: "",
		...
		},
		{
			...
			clients:        []BackupRestoreClientEntry{{Name: "core", Client: new(mocks.WorkingCoreBackupRestore)}, {Name: "", Client: new(mocks.FailingBackupRestore)}, {Name: "queryflow", Client: new(mocks.WorkingQueryFlowBackupRestore)}},
			path:           filepath.Join(t.TempDir(), "export.zip"),
			expectedOutput: "",
			err:            errors.New("path cannot be empty"),
		},
...
func TestImportEntitiesFromClient(t *testing.T) {
	tests := []struct {
		...
		// Working case
		{
			...
			client:         new(mocks.WorkingCoreBackupRestore),
		...
		},
		{
			...
			client:         new(mocks.WorkingQueryFlowBackupRestore),
