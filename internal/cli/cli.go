...
type Discovery interface {
	...
	SearchDumpBucket(client SearchDumper, contentProvider func(string) StagingContentController, nameOrID, file string, filters, projections gjson.Result, size *int, printer Printer) error
